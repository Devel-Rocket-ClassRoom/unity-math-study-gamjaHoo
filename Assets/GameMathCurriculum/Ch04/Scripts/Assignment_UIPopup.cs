...
public class Assignment_UIPopup : MonoBehaviour
{
    ...
    private void UpdateAnimation()
    {
        ...
        if (currentState == PopupState.Showing)
        {
            ...
            popupPanel.localScale = new Vector3(EaseOut(t), EaseOut(t), EaseOut(t));
        ...
        {
            // TODO
            canvasGroup.alpha = 1f - EaseIn(t);
            popupPanel.localScale = new Vector3(1f - EaseIn(t), 1f - EaseIn(t), 1f - EaseIn(t));
